...
const addCardBag = (event) => {
  ...
  product.querySelector(".fechar").addEventListener("click", removeProductBag);
  product
...
carrinho.addEventListener("click", openModalCheckOut);

const finalizarcarrinho = document.querySelector(".closed");
finalizarcarrinho.addEventListener("click", closedModal);
